    ...
    <div class="content-header">
      <div class="container ">
        <div class="row mb-2">
          ...
          <div class="col-sm-8">
            <h3 class="head m-0 text-center">NewsLetter Details</h3>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
                 ...
                 if ($result->num_rows>0) {
                  ...
                  <div class="card card-widget card-custom widget-user-2">
                    ...
                    <div class="widget-user-header">
                      <h4 class="text-center" style="text-transform: capitalize;"><b><?php echo $row['title']  ?></b></h3>
                      <h6 class="text-center"><i class="fas fa-clock"></i><?php echo $row['nl_time']; ?> </h6>
                    </div>
                    <div class=" card-body">
                      ...
                      <p><?php
                          ...
                          if (! in_array($ext, $allowed)) {
                            echo "<div class='mt-3 text-center'><a href='../files/".$row['attachments']."' target='_blank'><img class='img-fluid ' src='" .$row['attachments']."' alt='photo'></a></div>";

                          }
                          else{?>
                            <div class='mt-3 text-center'>Attachment:<br><a href="../files/<?php echo $row['attachments']; ?>  "target='_blank'><?php echo $row['attachments']; ?>  </a></div>
                          <?php  }
